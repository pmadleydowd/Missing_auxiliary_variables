...
forvalues sim = 1(1)$simno {
	...
	* run models 
	...
	tempname memhold 
	postfile `memhold' sim auxid auxcorr full cca imp aux misprop beta se fmi prop_yzmiss using "$Datadir/Efficiency_imputation/`auxmis'/simout_sim`sim'_auxid`auxid'.dta", replace
